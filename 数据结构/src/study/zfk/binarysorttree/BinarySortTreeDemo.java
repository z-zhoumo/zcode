package study.zfk.binarysorttree;


/*
？？？？？？？？？？？？？？？？？？？？？？
I can not understand to the code.
this code is very 麻了。
 */
public class BinarySortTreeDemo {
    public static void main(String[] args) {
        int[] arr = {7,3,10,12,5,1,9,66,90,21};
//        int[] arr = {7,3,10,12,5,1,9};
        ...
        */
        for (int i = 0; i < arr.length; i++) {
            tree.add(new BinarySortTree.Node(arr[i]));//1 3 5 7 9 10 12
        }
